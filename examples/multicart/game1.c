...
** "1" so you can see which ROM the runtime loader pulled off the cartridge.
** Games 2 and 3 are identical bar the number and colour. There is no path back
...
void main (void)
{
    ...
    for (;;) {
        ...
        gfx_outtextxy (60, 26, "1");
        gfx_settextscale (0x0100, 0x0100);
        gfx_outtextxy (44, 84, "GAME ONE");
