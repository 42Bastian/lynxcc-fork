...
;                   ----------
        ...
        .export         _eeprom_93c66_read
        .export         _eeprom_93c66_write
        .import         popax
        .importzp       ptr1
...
; unsigned int __fastcall__ eeprom_93c66_read(unsigned int addr);
_eeprom_93c66_read:
        ldx #EE_C_READ
        jsr EE_Send11Bit
        jsr EE_Read16Bit
...
; void __fastcall__ eeprom_93c66_write(unsigned int addr, unsigned int val);
_eeprom_93c66_write:
        sta ptr1
        stx ptr1+1
        ldx #EE_C_EWEN
