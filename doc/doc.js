...
var TOPBAR_HTML = `<div class="topbar"><a class="brand" href="index.html"><img class="brand-logo" src="logo.svg" alt=""><span>lynxcc</span></a><nav class="nav"><div class="dropdown"><button type="button" class="dropbtn" aria-haspopup="true" aria-expanded="false">Usage</button><div class="dropdown-menu"><a href="intro.html"><span>Introduction</span><span class="tdesc">hello world tutorial</span></a><a href="coding.html"><span>Coding hints</span><span class="tdesc">effective cc65 code</span></a><a href="smc.html"><span>Self-modifying code</span><span class="tdesc">SMC ca65 macros</span></a><a href="using-make.html"><span>Using make</span><span class="tdesc">build with GNU Make</span></a><a href="migrating.html"><span>Migrating</span><span class="tdesc">port from cc65</span></a><a href="samples.html"><span>Sample programs</span><span class="tdesc">annotated examples</span></a></div></div><div class="dropdown"><button type="button" class="dropbtn" aria-haspopup="true" aria-expanded="false">Tools</button><div class="dropdown-menu"><a href="abccc.html"><span>abccc</span><span class="tdesc">tune compiler</span></a><a href="abcrom.html"><span>abcrom</span><span class="tdesc">tune test-ROM</span></a><a href="ar65.html"><span>ar65</span><span class="tdesc">object archiver</span></a><a href="ca65.html"><span>ca65</span><span class="tdesc">macro assembler</span></a><a href="cc65.html"><span>cc65</span><span class="tdesc">C compiler</span></a><a href="cl65.html"><span>cl65</span><span class="tdesc">compile &amp; link</span></a><a href="da65.html"><span>da65</span><span class="tdesc">disassembler</span></a><a href="hmcc.html"><span>hmcc</span><span class="tdesc">HandyMusic compiler</span></a><a href="ld65.html"><span>ld65</span><span class="tdesc">linker</span></a><a href="lnx.html"><span>lnx</span><span class="tdesc">cartridge tool</span></a><a href="lynxdir.html"><span>lynxdir</span><span class="tdesc">ROM builder</span></a><a href="palgen.html"><span>palgen</span><span class="tdesc">palette generator</span></a><a href="sp65.html"><span>sp65</span><span class="tdesc">sprite &amp; bitmap</span></a><a href="sprpck.html"><span>sprpck</span><span class="tdesc">BMP/SPS packer</span></a></div></div><div class="dropdown"><button type="button" class="dropbtn" aria-haspopup="true" aria-expanded="false">Reference</button><div class="dropdown-menu"><a href="funcref.html"><span>Function reference</span><span class="tdesc">standard library</span></a><a href="cart.html"><span>Cart ROM &amp; EEPROM</span><span class="tdesc">image, saves &amp; I/O</span></a><a href="collisions.html"><span>Collision detection</span><span class="tdesc">buffer &amp; depository</span></a><a href="comlynx.html"><span>ComLynx serial</span><span class="tdesc">link-up &amp; UART</span></a><a href="graphics.html"><span>Graphics</span><span class="tdesc">display, double buffering</span></a><a href="lynx_gfx_fonts.html"><span>Graphics fonts</span><span class="tdesc">glyph tables</span></a><a href="handymusic.html"><span>HandyMusic</span><span class="tdesc">BGM &amp; SFX engine</span></a><a href="handymusic-scoring.html"><span>HandyMusic scoring</span><span class="tdesc">sheet music to tracks</span></a><a href="hardware.html"><span>Hardware registers</span><span class="tdesc">vectors, Mikey &amp; Suzy</span></a><a href="joypad.html"><span>Joypad input</span><span class="tdesc">buttons &amp; debouncing</span></a><a href="memory.html"><span>Memory</span><span class="tdesc">layout, stack &amp; heap</span></a><a href="multicart.html"><span>Multicart</span><span class="tdesc">bundle games in one cart</span></a><a href="sdcard-gd.html"><span>SD/GD flash cart</span><span class="tdesc">RetroHQ cartridge</span></a><a href="sound.html"><span>Sound</span><span class="tdesc">music engine</span></a><a href="sprites.html"><span>Sprites</span><span class="tdesc">SCBs, types &amp; penpal</span></a></div></div><div class="dropdown"><button type="button" class="dropbtn" aria-haspopup="true" aria-expanded="false">About</button><div class="dropdown-menu"><a href="compilerbugs.html"><span>Compiler bugs</span><span class="tdesc">fixed &amp; known bugs</span></a><a href="history.html"><span>History</span><span class="tdesc">authors &amp; credits</span></a><a href="licenses.html"><span>Licenses</span><span class="tdesc">copyright notices</span></a><a href="optlim.html"><span>Optimizations &amp; Limitations</span><span class="tdesc">code-gen &amp; limits</span></a></div></div></nav><button id="docSearchBtn" class="doc-search-btn" aria-label="Search documentation" title="Search  (press / or Ctrl-K)"><span class="ic-search">⌕</span></button><button id="themeToggle" class="theme-toggle" aria-label="Toggle theme" title="Toggle light/dark"><span class="ic-sun">☀</span><span class="ic-moon">☾</span></button></div>`;
...
var SEARCH_INDEX = [
  ...
  ["compilerbugs.html","sect-1","1. How bugs are found and tracked"],
  ["compilerbugs.html","sect-2","2. Fixed bugs"],
  ["compilerbugs.html","sect-3","3. Known open bugs"],
  ...
  ["funcref.html","multicart.h","2.10. lynx/multicart.h"],
  ["funcref.html","peekpoke.h","2.11. peekpoke.h"],
  ["funcref.html","sdcard-gd.h","2.12. lynx/sdcard-gd.h"],
  ["funcref.html","serial.h","2.13. lynx/serial.h"],
  ["funcref.html","setjmp.h","2.14. setjmp.h"],
  ["funcref.html","stdarg.h","2.15. stdarg.h"],
  ["funcref.html","stdbool.h","2.16. stdbool.h"],
  ["funcref.html","stddef.h","2.17. stddef.h"],
  ["funcref.html","stdio.h","2.18. stdio.h"],
  ["funcref.html","stdlib.h","2.19. stdlib.h"],
  ["funcref.html","string.h","2.20. string.h"],
  ["funcref.html","suzymath.h","2.21. lynx/suzymath.h"],
  ["funcref.html","gfx.h","2.22. lynx/gfx.h"],
  ["funcref.html","time.h","2.23. time.h"],
  ["funcref.html","unistd.h","2.24. unistd.h"],
  ["funcref.html","zlib.h","2.25. lynx/zlib.h"],
  ["funcref.html","handymusic.h","2.26. lynx/handymusic.h"],
  ...
  ["funcref.html","gfx_setdefpalette","3.55. gfx_setdefpalette"],
  ["funcref.html","gfx_setdrawpage","3.56. gfx_setdrawpage"],
  ["funcref.html","gfx_setfont","3.57. gfx_setfont"],
  ["funcref.html","gfx_setframerate","3.58. gfx_setframerate"],
  ["funcref.html","gfx_setpalette","3.59. gfx_setpalette"],
  ["funcref.html","gfx_setpalette16","3.60. gfx_setpalette16"],
  ["funcref.html","gfx_settextdir","3.61. gfx_settextdir"],
  ["funcref.html","gfx_settextscale","3.62. gfx_settextscale"],
  ["funcref.html","gfx_settextstyle","3.63. gfx_settextstyle"],
  ["funcref.html","gfx_setviewpage","3.64. gfx_setviewpage"],
  ["funcref.html","gfx_sprite","3.65. gfx_sprite"],
  ["funcref.html","gfx_updatedisplay","3.66. gfx_updatedisplay"],
  ["funcref.html","handymusic_init","3.67. handymusic_init"],
  ["funcref.html","handymusic_pause","3.68. handymusic_pause"],
  ["funcref.html","handymusic_pcm_playing","3.69. handymusic_pcm_playing"],
  ["funcref.html","handymusic_play_music","3.70. handymusic_play_music"],
  ["funcref.html","handymusic_play_pcm","3.71. handymusic_play_pcm"],
  ["funcref.html","handymusic_play_sfx","3.72. handymusic_play_sfx"],
  ["funcref.html","handymusic_register_pcm","3.73. handymusic_register_pcm"],
  ["funcref.html","handymusic_stop_all","3.74. handymusic_stop_all"],
  ["funcref.html","handymusic_stop_music","3.75. handymusic_stop_music"],
  ["funcref.html","handymusic_stop_sfx","3.76. handymusic_stop_sfx"],
  ["funcref.html","handymusic_unpause","3.77. handymusic_unpause"],
  ["funcref.html","isalnum","3.78. isalnum"],
  ["funcref.html","isalpha","3.79. isalpha"],
  ["funcref.html","isascii","3.80. isascii"],
  ["funcref.html","isblank","3.81. isblank"],
  ["funcref.html","isdigit","3.82. isdigit"],
  ["funcref.html","isgraph","3.83. isgraph"],
  ["funcref.html","islower","3.84. islower"],
  ["funcref.html","isprint","3.85. isprint"],
  ["funcref.html","ispunct","3.86. ispunct"],
  ["funcref.html","isspace","3.87. isspace"],
  ["funcref.html","isupper","3.88. isupper"],
  ["funcref.html","isxdigit","3.89. isxdigit"],
  ["funcref.html","itoa","3.90. itoa"],
  ["funcref.html","joy_read","3.91. joy_read"],
  ["funcref.html","labs","3.92. labs"],
  ["funcref.html","longjmp","3.93. longjmp"],
  ["funcref.html","ltoa","3.94. ltoa"],
  ["funcref.html","lynx_exec","3.95. lynx_exec"],
  ["funcref.html","lynx_load","3.96. lynx_load"],
  ["funcref.html","malloc","3.97. malloc"],
  ["funcref.html","memchr","3.98. memchr"],
  ["funcref.html","memcmp","3.99. memcmp"],
  ["funcref.html","memcpy","3.100. memcpy"],
  ["funcref.html","memmove","3.101. memmove"],
  ["funcref.html","memset","3.102. memset"],
  ["funcref.html","mikey_snd_integrate","3.103. mikey_snd_integrate"],
  ["funcref.html","mikey_snd_octave","3.104. mikey_snd_octave"],
  ["funcref.html","mikey_snd_pitch","3.105. mikey_snd_pitch"],
  ["funcref.html","mikey_snd_taps","3.106. mikey_snd_taps"],
  ["funcref.html","mikey_snd_volume","3.107. mikey_snd_volume"],
  ["funcref.html","multicart_run","3.108. multicart_run"],
  ["funcref.html","offsetof","3.109. offsetof"],
  ["funcref.html","openn","3.110. openn"],
  ["funcref.html","poweroff","3.111. poweroff"],
  ["funcref.html","qsort","3.112. qsort"],
  ["funcref.html","rand","3.113. rand"],
  ["funcref.html","realloc","3.114. realloc"],
  ["funcref.html","reset_irq","3.115. reset_irq"],
  ["funcref.html","sdcard_gd_clear","3.116. sdcard_gd_clear"],
  ["funcref.html","sdcard_gd_close","3.117. sdcard_gd_close"],
  ["funcref.html","sdcard_gd_init","3.118. sdcard_gd_init"],
  ["funcref.html","sdcard_gd_lowpower","3.119. sdcard_gd_lowpower"],
  ["funcref.html","sdcard_gd_open","3.120. sdcard_gd_open"],
  ["funcref.html","sdcard_gd_opendir","3.121. sdcard_gd_opendir"],
  ["funcref.html","sdcard_gd_program","3.122. sdcard_gd_program"],
  ["funcref.html","sdcard_gd_read","3.123. sdcard_gd_read"],
  ["funcref.html","sdcard_gd_readdir","3.124. sdcard_gd_readdir"],
  ["funcref.html","sdcard_gd_seek","3.125. sdcard_gd_seek"],
  ["funcref.html","sdcard_gd_size","3.126. sdcard_gd_size"],
  ["funcref.html","sdcard_gd_write","3.127. sdcard_gd_write"],
  ["funcref.html","ser_close","3.128. ser_close"],
  ["funcref.html","ser_get","3.129. ser_get"],
  ["funcref.html","ser_open","3.130. ser_open"],
  ["funcref.html","ser_put","3.131. ser_put"],
  ["funcref.html","ser_status","3.132. ser_status"],
  ["funcref.html","set_irq","3.133. set_irq"],
  ["funcref.html","setjmp","3.134. setjmp"],
  ["funcref.html","sleep","3.135. sleep"],
  ["funcref.html","snd_active","3.136. snd_active"],
  ["funcref.html","snd_continue","3.137. snd_continue"],
  ["funcref.html","snd_init","3.138. snd_init"],
  ["funcref.html","snd_pause","3.139. snd_pause"],
  ["funcref.html","snd_play","3.140. snd_play"],
  ["funcref.html","snd_stop","3.141. snd_stop"],
  ["funcref.html","snd_stop_channel","3.142. snd_stop_channel"],
  ["funcref.html","snprintf","3.143. snprintf"],
  ["funcref.html","sprintf","3.144. sprintf"],
  ["funcref.html","srand","3.145. srand"],
  ["funcref.html","sscanf","3.146. sscanf"],
  ["funcref.html","strcasecmp","3.147. strcasecmp"],
  ["funcref.html","strcat","3.148. strcat"],
  ["funcref.html","strchr","3.149. strchr"],
  ["funcref.html","strcmp","3.150. strcmp"],
  ["funcref.html","strcoll","3.151. strcoll"],
  ["funcref.html","strcpy","3.152. strcpy"],
  ["funcref.html","strcspn","3.153. strcspn"],
  ["funcref.html","strdup","3.154. strdup"],
  ["funcref.html","strerror","3.155. strerror"],
  ["funcref.html","stricmp","3.156. stricmp"],
  ["funcref.html","strlen","3.157. strlen"],
  ["funcref.html","strlower","3.158. strlower"],
  ["funcref.html","strlwr","3.159. strlwr"],
  ["funcref.html","strncasecmp","3.160. strncasecmp"],
  ["funcref.html","strncat","3.161. strncat"],
  ["funcref.html","strncmp","3.162. strncmp"],
  ["funcref.html","strncpy","3.163. strncpy"],
  ["funcref.html","strnicmp","3.164. strnicmp"],
  ["funcref.html","strpbrk","3.165. strpbrk"],
  ["funcref.html","strqtok","3.166. strqtok"],
  ["funcref.html","strrchr","3.167. strrchr"],
  ["funcref.html","strspn","3.168. strspn"],
  ["funcref.html","strstr","3.169. strstr"],
  ["funcref.html","strtok","3.170. strtok"],
  ["funcref.html","strupper","3.171. strupper"],
  ["funcref.html","strupr","3.172. strupr"],
  ["funcref.html","strxfrm","3.173. strxfrm"],
  ["funcref.html","suzy_div_result","3.174. suzy_div_result"],
  ["funcref.html","suzy_div_start","3.175. suzy_div_start"],
  ["funcref.html","suzy_math_busy","3.176. suzy_math_busy"],
  ["funcref.html","suzy_mod_result","3.177. suzy_mod_result"],
  ["funcref.html","suzy_mod_start","3.178. suzy_mod_start"],
  ["funcref.html","suzy_mul_result","3.179. suzy_mul_result"],
  ["funcref.html","suzy_mul_start","3.180. suzy_mul_start"],
  ["funcref.html","suzy_muldiv_result","3.181. suzy_muldiv_result"],
  ["funcref.html","suzy_muldiv_start","3.182. suzy_muldiv_start"],
  ["funcref.html","suzy_udiv_result","3.183. suzy_udiv_result"],
  ["funcref.html","suzy_udiv_start","3.184. suzy_udiv_start"],
  ["funcref.html","suzy_umod_result","3.185. suzy_umod_result"],
  ["funcref.html","suzy_umod_start","3.186. suzy_umod_start"],
  ["funcref.html","suzy_umul_result","3.187. suzy_umul_result"],
  ["funcref.html","suzy_umul_start","3.188. suzy_umul_start"],
  ["funcref.html","suzy_umuldiv_result","3.189. suzy_umuldiv_result"],
  ["funcref.html","suzy_umuldiv_start","3.190. suzy_umuldiv_start"],
  ["funcref.html","tolower","3.191. tolower"],
  ["funcref.html","toupper","3.192. toupper"],
  ["funcref.html","ultoa","3.193. ultoa"],
  ["funcref.html","utoa","3.194. utoa"],
  ["funcref.html","vsnprintf","3.195. vsnprintf"],
  ["funcref.html","vsprintf","3.196. vsprintf"],
  ["funcref.html","vsscanf","3.197. vsscanf"],
  ...
  ["graphics.html","sect-7","7. Panning the display window: hoff and voff"],
  ["graphics.html","sect-8","8. Sprites, collision and going deeper"],
  ["graphics.html","sect-9","9. License"],
  ["handymusic-scoring.html","sect-1","1. The mental model: ticks, not tempo"],
  ["handymusic-scoring.html","sect-2","2. Pitch: staff notes to nXo"],
  ["handymusic-scoring.html","sect-2-1","2.1. Octaves and middle C"],
  ["handymusic-scoring.html","sect-2-2","2.2. Accidentals and tuning"],
  ["handymusic-scoring.html","sect-3","3. Rhythm: note values to ticks"],
  ["handymusic-scoring.html","sect-3-1","3.1. Choose a ticks-per-beat resolution"],
  ["handymusic-scoring.html","sect-3-2","3.2. Quick conversion table"],
  ["handymusic-scoring.html","sect-3-3","3.3. Notes, rests and holds"],
  ["handymusic-scoring.html","sect-4","4. Worked example: a melody"],
  ["handymusic-scoring.html","sect-4-1","4.1. Reading the staff"],
  ["handymusic-scoring.html","sect-4-2","4.2. The finished track block"],
  ["handymusic-scoring.html","sect-4-3","4.3. Compiling it"],
  ["handymusic-scoring.html","sect-5","5. Worked example: keeping voices aligned"],
  ["handymusic-scoring.html","sect-6","6. Tips and pitfalls"],
  ["handymusic-scoring.html","sect-7","7. See also"],
  ["handymusic.html","sect-1","1. What HandyMusic is"],
  ["handymusic.html","sect-2","2. Building against the engine"],
  ["handymusic.html","sect-3","3. The reserved data regions"],
  ["handymusic.html","sect-3-1","3.1. Why the data is absolute"],
  ["handymusic.html","sect-3-2","3.2. Copying the blobs at startup"],
  ["handymusic.html","sect-4","4. Channels, the VBL tick and decoding"],
  ["handymusic.html","sect-5","5. The C API"],
  ["handymusic.html","sect-5-1","5.1. Playback control"],
  ["handymusic.html","sect-5-2","5.2. Pointing the driver at the SFX tables"],
  ["handymusic.html","sect-6","6. PCM sample playback"],
  ["handymusic.html","sect-7","7. Worked example: handymusic.c"],
  ["handymusic.html","sect-8","8. License"],
  ["hardware.html","sect-1","1. Memory-mapped hardware"],
  ["hardware.html","sect-2","2. MAPCTL: the address-space overlay"],
  ["hardware.html","sect-2-1","2.1. The overlay bits"],
  ["hardware.html","sect-2-2","2.2. What lynxcc sets"],
  ["hardware.html","sect-3","3. The 6502 hardware vectors"],
  ["hardware.html","sect-3-1","3.1. NMI, RESET and IRQ"],
  ["hardware.html","sect-3-2","3.2. Setting a vector to various values"],
  ["hardware.html","sect-4","4. The single-IRQ interrupt model"],
  ["hardware.html","sect-4-1","4.1. INTSET and INTRST"],
  ["hardware.html","sect-4-2","4.2. Timer interrupt bits"],
  ["hardware.html","sect-4-3","4.3. Installing a handler"],
  ["hardware.html","sect-5","5. Mikey constants and register map"],
  ["hardware.html","sect-5-1","5.1. Timers"],
  ["hardware.html","sect-5-2","5.2. Audio"],
  ["hardware.html","sect-5-3","5.3. System and I/O control"],
  ["hardware.html","sect-5-4","5.4. Full Mikey map"],
  ["hardware.html","sect-6","6. Suzy constants and register map"],
  ["hardware.html","sect-6-1","6.1. The sprite-engine registers"],
  ["hardware.html","sect-6-2","6.2. SPRCTL0, SPRCTL1 and SPRSYS"],
  ["hardware.html","sect-6-3","6.3. Hardware-math registers"],
  ["hardware.html","sect-6-4","6.4. Joypad and switches"],
  ["hardware.html","sect-6-5","6.5. Full Suzy map"],
  ["hardware.html","sect-7","7. Reaching the registers from C and assembly"],
  ["hardware.html","sect-8","8. License"],
  ...
  ["hmcc.html","sect-1","1. Overview"],
  ["hmcc.html","sect-2","2. The two compile modes"],
  ["hmcc.html","sect-3","3. Instrument & SFX scripts"],
  ["hmcc.html","sect-3-1","3.1. Declaring an instrument"],
  ["hmcc.html","sect-3-2","3.2. Header and body commands"],
  ["hmcc.html","sect-3-3","3.3. Tuning and note frequencies"],
  ["hmcc.html","sect-4","4. Music scripts"],
  ["hmcc.html","sect-4-1","4.1. Blocks, tracks and the main block"],
  ["hmcc.html","sect-4-2","4.2. Track commands"],
  ["hmcc.html","sect-5","5. Output files and the base address"],
  ["hmcc.html","sect-6","6. Usage"],
  ["hmcc.html","sect-6-1","6.1. Command line"],
  ["hmcc.html","sect-6-2","6.2. The build flow"],
  ["hmcc.html","sect-7","7. Copyright"],
  ...
  ["ld65.html","sect-6-3","6.2. STARTUP"],
  ["ld65.html","sect-6-4","6.3. ZPSAVE"],
  ...
  ["licenses.html","sect-4-5","4.5. HandyMusic / hmcc — author's grant (derived port)"],
  ...
  ["lynxdir.html","sect-1","1. Overview"],
  ["lynxdir.html","sect-2","2. Usage"],
  ["lynxdir.html","sect-2-1","2.1. Command line"],
  ["lynxdir.html","sect-2-2","2.2. The two required files"],
  ["lynxdir.html","mak","3. The .mak config file"],
  ["lynxdir.html","sect-3-1","3.1. Syntax"],
  ["lynxdir.html","sect-3-2","3.2. Choosing a loader"],
  ["lynxdir.html","sect-3-3","3.3. ROM-wide commands"],
  ["lynxdir.html","sect-3-4","3.4. Per-file switches"],
  ["lynxdir.html","sect-3-5","3.5. Bank switching"],
  ["lynxdir.html","sect-3-6","3.6. .lnx header and EEPROM flags"],
  ["lynxdir.html","output","4. Output"],
  ["lynxdir.html","examples","5. Config examples"],
  ["lynxdir.html","vs-lnx","6. lynxdir versus lnx"],
  ["lynxdir.html","sect-7","7. Copyright and licence"],
  ...
  ["migrating.html","sect-defpalette","8. Default palette no longer auto-loaded"],
  ["multicart.html","sect-1","1. What a multicart is"],
  ["multicart.html","sect-2","2. Building one"],
  ["multicart.html","sect-3","3. The cart layout"],
  ["multicart.html","sect-3-1","3.1. The game directory"],
  ["multicart.html","sect-4","4. Launching a game: multicart_run()"],
  ["multicart.html","sect-5","5. The relocatable runtime loader"],
  ["multicart.html","sect-6","6. Writing a menu"],
  ["multicart.html","sect-7","7. Limitations and gotchas"],
  ["multicart.html","sect-8","8. License"],
  ["optlim.html","sect-1","1. Lynx-specific code-generation optimizations"],
  ["optlim.html","sect-2","2. Limitations"],
  ["optlim.html","sect-3","3. Known compiler bugs (under audit)"],
  ["palgen.html","sect-1","1. Overview"],
  ["palgen.html","generator","2. The generator"],
  ["palgen.html","sect-3","3. The two output arrays"],
  ["palgen.html","sect-3-1","3.1. The gfx_setpalette() array"],
  ["palgen.html","sect-3-2","3.2. The gfx_setpalette16() array"],
  ["palgen.html","sect-4","4. How the conversion works"],
  ["palgen.html","sect-5","5. Copyright"],
  ...
  ["sprites.html","sect-6-1","6.1. Where the action point sits"],
  ["sprites.html","sect-6-2","6.2. Flipping about the reference point"],
