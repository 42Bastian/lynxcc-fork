...
/* a 0 count ends the sprite. Sybil's frames use the identity penpal, so */
/* the nibble values are palette pens directly.                         */
/* ------------------------------------------------------------------ */

/* Sybil idle/run frames, 16x16, right-facing then pre-mirrored left.   */
static unsigned char syb0[] = {
    
};
static unsigned char syb0l[] = {
    
};
static unsigned char syb1[] = {
    ...
    0x09, 0x00, 0x00, 0xF7, 0xA1, 0x11, 0xF0, 0x00, 0x00,
    0x09, 0x00, 0x00, 0xF7, 0x7A, 0xBF, 0x00, 0x00, 0x00,
    0x09, 0x00, 0x0F, 0xED, 0x4A, 0xF0, 0x00, 0x00, 0x00,
    0x09, 0x00, 0x0F, 0xEB, 0xB4, 0x4F, 0xFF, 0x00, 0x00,
    0x09, 0x00, 0x0F, 0xDA, 0xAB, 0x31, 0xCC, 0xF0, 0x00,
    0x09, 0x00, 0x0F, 0xDC, 0x3A, 0xBA, 0x1C, 0xCF, 0x00,
    0x09, 0x00, 0x00, 0xFC, 0x31, 0xFB, 0xBF, 0xF0, 0x00,
    0x09, 0x00, 0x00, 0xF3, 0x14, 0x4F, 0x1F, 0x00, 0x00,
    0x09, 0x00, 0x00, 0x0F, 0x33, 0x34, 0xF0, 0x00, 0x00,
    0x09, 0x00, 0x00, 0xF1, 0x3F, 0x14, 0xF0, 0x00, 0x00,
    0x09, 0x00, 0x0F, 0x13, 0xF0, 0xF1, 0x3F, 0x00, 0x00,
    0x09, 0x00, 0x0F, 0x11, 0x1F, 0xF1, 0x11, 0xF0, 0x00,
...
static unsigned char syb1l[] = {
    ...
    0x09, 0x00, 0x00, 0x0F, 0x11, 0x1A, 0x7F, 0x00, 0x00,
    0x09, 0x00, 0x00, 0x00, 0xFB, 0xA7, 0x7F, 0x00, 0x00,
    0x09, 0x00, 0x00, 0x00, 0x0F, 0xA4, 0xDE, 0xF0, 0x00,
    0x09, 0x00, 0x00, 0xFF, 0xF4, 0x4B, 0xBE, 0xF0, 0x00,
    0x09, 0x00, 0x0F, 0xCC, 0x13, 0xBA, 0xAD, 0xF0, 0x00,
    0x09, 0x00, 0xFC, 0xC1, 0xAB, 0xA3, 0xCD, 0xF0, 0x00,
    0x09, 0x00, 0x0F, 0xFB, 0xBF, 0x13, 0xCF, 0x00, 0x00,
    0x09, 0x00, 0x00, 0xF1, 0xF4, 0x41, 0x3F, 0x00, 0x00,
    0x09, 0x00, 0x00, 0x0F, 0x43, 0x33, 0xF0, 0x00, 0x00,
    0x09, 0x00, 0x00, 0x0F, 0x41, 0xF3, 0x1F, 0x00, 0x00,
    0x09, 0x00, 0x00, 0xF3, 0x1F, 0x0F, 0x31, 0xF0, 0x00,
    0x09, 0x00, 0x0F, 0x11, 0x1F, 0xF1, 0x11, 0xF0, 0x00,
...
static unsigned char syb2[] = {
    ...
    
};
static unsigned char syb2l[] = {
    ...
    
};
...
static unsigned char en_a[] = {
    0x07, 0x00, 0x00, 0x11, 0x11, 0x00, 0x00,
    0x07, 0x00, 0x11, 0x11, 0x11, 0x11, 0x00,
    0x07, 0x01, 0x11, 0x11, 0x11, 0x11, 0x10,
    0x07, 0x01, 0x12, 0x21, 0x12, 0x21, 0x10,
    0x07, 0x01, 0x12, 0x31, 0x12, 0x31, 0x10,
    0x07, 0x01, 0x11, 0x11, 0x11, 0x11, 0x10,
    0x07, 0x01, 0x11, 0x11, 0x11, 0x11, 0x10,
    0x07, 0x00, 0x11, 0x11, 0x11, 0x11, 0x00,
    0x07, 0x01, 0x11, 0x00, 0x00, 0x11, 0x10,
    0x07, 0x11, 0x00, 0x00, 0x00, 0x00, 0x11,
    0x00
};
static unsigned char en_b[] = {
    ...
    0x07, 0x01, 0x11, 0x11, 0x11, 0x11, 0x10,
    0x07, 0x00, 0x11, 0x11, 0x11, 0x11, 0x00,
    0x07, 0x00, 0x11, 0x10, 0x01, 0x11, 0x00,
    0x07, 0x01, 0x10, 0x00, 0x00, 0x01, 0x10,
    0x00
};
